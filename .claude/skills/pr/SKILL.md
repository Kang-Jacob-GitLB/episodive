...
allowed-tools: Bash(git status:*), Bash(git log:*), Bash(git branch:*), Bash(git diff:*), Bash(git push:*), Bash(gh pr create:*), Bash(gh pr view:*)
---
...
- 이미 PR이 열려 있으면 중단하고 PR URL을 알린다.
